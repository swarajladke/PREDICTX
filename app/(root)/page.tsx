...
const Home = () => { 
    ...
    return ( 
      <div className="flex flex-col min-h-screen home-wrapper gap-8"> 
        <div className="dashboard-banner rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-7 mb-4 sm:mb-6 mt-2 flex flex-col items-center justify-center text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 px-2 sm:px-0">
            <h1 className="font-extrabold text-transparent text-2xl sm:text-3xl md:text-4xl bg-clip-text bg-gradient-to-r from-yellow-400 via-blue-400 to-teal-400 animate-fade-in drop-shadow-lg">
              Welcome to PredictX
            </h1>
            <p className="mt-2 sm:mt-3 max-w-2xl mx-auto text-sm sm:text-base md:text-lg text-gray-300 animate-fade-in-delay font-medium px-2">
              Your real-time stock market dashboard powered by intelligent analytics and dynamic alerts.
            </p>
          </div>
        </div>
        <section className="grid w-full gap-4 sm:gap-6 md:gap-8 home-section">
